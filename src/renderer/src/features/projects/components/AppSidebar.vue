...
<template>
  <aside class="flex flex-col h-full bg-neutral-900 border-r border-white/10 w-64 shrink-0">
    <!-- File tree view -->
    <FileTree v-if="store.activeProject" />
    ...
    <template v-else>
      ...
      <ProjectList
        ...
        @select="handleSelectProject($event)"
      />
      ...
      <div class="px-3 py-3 border-t border-white/10">
        ...
        <AddProjectButton v-else @add="handleAddProject" />
      </div>
    </template>
  </aside>
</template>
